...
// ── Desktop Shell ─────────────────────────────────────────────
function DesktopShell({ tab, onNav, balance, children, title, sub, hideSearch, onSelectMatch, onSelectUser }) {
...
// ── Desktop App (root) ────────────────────────────────────────
export default function DesktopApp({ tab, setTab, balance, openBet, matches, onSelectMatch, onSelectUser }) {
  const titles = {
